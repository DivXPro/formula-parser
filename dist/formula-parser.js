...
exports.getCorrectResult = getCorrectResult;
...
function accAdd(num1, num2) {
  ...
  times = Math.pow(10, Math.max(dec1, dec2)); // var result = (num1 * times + num2 * times) / times;

  var result = (accMul(num1, times) + accMul(num2, times)) / times;
  return getCorrectResult("add", num1, num2, result); // return result;
}
...
function accSub(num1, num2) {
  ...
  times = Math.pow(10, Math.max(dec1, dec2)); // var result = Number(((num1 * times - num2 * times) / times);

  var result = Number((accMul(num1, times) - accMul(num2, times)) / times);
  return getCorrectResult("sub", num1, num2, result); // return result;
}
...
function accDiv(num1, num2) {
  ...
  return getCorrectResult("div", num1, num2, result); // return result;
}
...
function accMul(num1, num2) {
  ...
  return getCorrectResult("mul", num1, num2, result); // return result;
}
...
var _accMath = __webpack_require__(4);
...
function func(first) {
  ...
  var result = rest.reduce(function (acc, value) {
    return (0, _accMath.accAdd)(acc, (0, _number.toNumber)(value));
...
function func(first) {
  ...
  var result = rest.reduce(function (acc, value) {
    return (0, _accMath.accDiv)(acc, (0, _number.toNumber)(value));
  }, (0, _number.toNumber)(first));
...
function func(first) {
  ...
  var result = rest.reduce(function (acc, value) {
    return (0, _accMath.accSub)(acc, (0, _number.toNumber)(value));
  }, (0, _number.toNumber)(first));
...
function func(first) {
  ...
  var result = rest.reduce(function (acc, value) {
    return (0, _accMath.accMul)(acc, (0, _number.toNumber)(value));
  }, (0, _number.toNumber)(first));
