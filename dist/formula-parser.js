...
exports.argsToArray = function(args) {
  ...
  if (args.length === 1 && Array.isArray(args[0])) {
    exports.arrayEach(args[0], function(value) {
      result.push(value);
    });
  } else {
...
exports.SUM = function() {
  ...
  utils.arrayEach(utils.argsToArray(arguments), function(value) {
    if (typeof value === 'number') {
      ...
      !isNaN(parsed) && (result = NP.plus(result, parsed));
...
var _formulajsPrecision = __webpack_require__(25);

var formulajs = _interopRequireWildcard(_formulajsPrecision);
